    ...
    <nav className="container header__wrapper">
      ...
      <ul className="header-list">
        <li className="header-list__item">
          <Link className="header-list__link" to="/en/">Home</Link>
        </li>
        
        <li className="header-list__item">
          <Link className="header-list__link" to="/en/services">Services</Link>
        </li>
        
        <li className="header-list__item">
          <Link className="header-list__link" to="/en/cases">Cases</Link>
        </li>
        
        <li className="header-list__item">
          <Link className="header-list__link" to="/en/blog">Blog</Link>
        </li>
      </ul>
